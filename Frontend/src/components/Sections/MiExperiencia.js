...
import { Container, Col, Row, Card, CardImg, CardBody, Button, UncontrolledTooltip } from "reactstrap"
    ...
    if (projects) {
        return (
            <Container style={{ marginTop: "10vh", marginBottom: "15vh" }}>
                <h1 className="mt-5 text-neutral text-center">También he trabajado de forma freelance en las siguientes páginas web:</h1>
                        ...
                        {projects.web_infos.map(site => (
                            <Col lg="4" className="mb-4" key={site.id}>
                                <Card style={{width: '20rem'}} id={site.website_img}>
                                    <CardImg top src={require("../../images/" + site.website_img + ".png")} alt="..."/>
                                ...
                                <UncontrolledTooltip placement="top" target={site.website_img} delay={0}>
                                    {site.website_name}
                                </UncontrolledTooltip>
                            </Col>
                        ))}
                ...
                <Row className="row-grid justify-content-around">
                    <Col lg="4" className="mb-4">
                        <Card style={{width: '20rem'}}>
                            <CardImg top src={require("../../images/saludyderechos.png")} alt="..."/>
                            <CardBody className="text-center">
