		...
		return (
			<React.Fragment>
				<Container style={{ marginTop: "10vh" }}>
					<h2 className="mt-5 text-center text-neutral">
						Más info acerca de precios y servicios indivuduales
					</h2>
					<h3 className="mt-5 pt-5 text-neutral text-center">
							...
							<Col lg="6" className="mb-4" key={dominio.id}>
								<Card className={this.renderSwitch(dominio.id)}>
									<CardBody>
										<button
											className="close"
											id={"dominio" + dominio.id}
											onClick={() =>
												this.callModal([
													dominio.titulo_secundario,
													dominio.texto_info,
												])
											}
										>
										...
										<CardTitle className="h3">
											{dominio.titulo_principal}
										</CardTitle>
										<CardTitle className="text-neutral font-weight-bold">
											{dominio.precio_dominio}
										</CardTitle>
									</CardBody>
								</Card>
							</Col>
					...
					<h3 className="mt-5 pt-5 text-neutral text-center">
						Páginas Web y opciones de Hosting
					</h3>
							...
							<Col lg="6" className="mb-4" key={proyecto.id}>
								<Card className={this.renderSwitch(proyecto.id)}>
									<CardBody>
										...
										<CardTitle className="h3">
											{proyecto.titulo_principal}
										</CardTitle>
										<CardTitle className="text-neutral font-weight-bold">
											{proyecto.costo_proyecto}
										</CardTitle>
										<CardTitle className="text-neutral font-weight-bold">
											{proyecto.costo_mensual}
										</CardTitle>
									</CardBody>
								</Card>
							</Col>
					...
					<img
						alt="..."
						className="path"
						style={{ transform: "scale(0.7)", marginTop: "-45vh", zIndex: "-1" }}
				...
				<Modal
					...
					isOpen={this.state.infoPrecioModal}
					toggle={() => this.toggleModal("infoPrecioModal")}
				>
					<div className="modal-header justify-content-center">
						<div>
							<button
								className="close"
								onClick={() => this.toggleModal("infoPrecioModal")}
							>
