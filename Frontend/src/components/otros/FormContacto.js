...
import {Contacto} from "components/Ajax/AjaxAirport"
...
class FormLogin extends React.Component {
    ...
    enviarConsulta = async () => {
        ...
        if (resultado) {
            ...
            this.setState({
                colorMensaje: "danger",
                mensaje: 'Su consulta no pudo ser enviada. Revise que todos los campos están completos (el campo "empresa" es opcional). Si esto continua sucediendo, vualva a intentarlo en unas horas.'
            })
        }
    }
            ...
            <Card className="card-plain">
                <CardBody>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Button className="btn-round float-right" color="primary" data-placement="right" id="tooltip341148792" type="submit">Enviar</Button>
